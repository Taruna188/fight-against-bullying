...
declare module '$env/static/private' {
	...
	export const npm_package_scripts_pages: string;
	...
	export const USERTASKBAR: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_scripts_pages: string;
